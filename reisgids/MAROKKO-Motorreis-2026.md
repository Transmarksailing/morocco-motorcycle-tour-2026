...
Een grote lus vanuit Moraira: kort de kust af naar Almería, met de nachtferry naar Nador, en dan tien dagen door het beste van Marokko. Van de groene Midden-Atlas met cederbossen en berbermakaken, via de Ziz-vallei de Sahara in tot de duinen van Erg Chebbi, door de spectaculaire Todra- en Dades-kloven, langs de UNESCO-kasbah Aït Benhaddou, over de legendarische Tizi n'Tichka-pas naar Marrakech, en via de Ouzoud-watervallen weer noordwaarts terug naar de haven.

> **Waarom oktober?** Dé maand voor Marokko: overdag 20–30 °C, aangename woestijntemperaturen, frisse ochtenden in de Atlas, weinig regen, heldere luchten en minder toeristen dan in de zomer.
...
## 🚢 De oversteek — Almería ↔ Nador

De ferry vaart in ± 6–8 uur over de Middellandse Zee. Neem heen én terug bij voorkeur een **nachtboot met hut**, zo verlies je geen rijdag en arriveer je 's ochtends fris in Nador.

- **Boeken:** [Baleària](https://www.balearia.com/en) of [Trasmediterranea/Naviera Armas](https://www.navieraarmas.com/en) — kies **Almería → Nador** (niet Melilla; Nador ligt in Marokko zelf, Melilla is Spaans en vereist een extra grensdoorgang).
- **Motor + hut:** boek een **buitenhut** en geef door dat het om motoren gaat (vastsjorren op het autodek).
- **Aankomst Nador:** haven **Beni Ansar**. Reken op **1–2 uur** grensformaliteiten (paspoortstempel + tijdelijke voertuiginvoer).
- 🛳️ [Overzicht & tijden — Directferries](https://www.directferries.com/almeria_nador_ferry.htm)

> 💡 **Tip:** boek de terugreis (dag 10, Nador → Almería) met wat marge; kom **minimaal 3 uur** vóór vertrek aan de terminal.
...
- **⛴️ Inchecken Almería** en 's avonds/'s nachts de ferry naar Nador. Slaap in de hut; morgenochtend begint Marokko.
  📍 [Haven Almería](https://www.google.com/maps/search/?api=1&query=36.8300,-2.4640) · 🛏️ [Hotels bij haven Almería](https://www.booking.com/city/es/almeria.html)
...
- **🌲 Cederbos bij Azrou** · Uitgestrekte ceder- en dennenbossen; kans op wilde **berbermakaken** (aap) langs de weg.
  📍 [Cèdre Gouraud / cederbos](https://www.google.com/maps/search/?api=1&query=33.4270,-5.1720) · 📷 [Foto's](https://www.google.com/search?tbm=isch&q=cedar+forest+Azrou+macaques)
- **🏔️ Ifrane** · Het verrassende "Zwitserland van Marokko" — alpiene chalets, schone straten, meertjes. Perfecte koffiestop.
...
- **🥇 Dades-haarspelden (R704)** · De favoriete rijweg van de gids: een reeks onvergetelijke haarspeldbochten die tegen de rode rotswand omhoog kronkelen. Rijd een stuk de kloof in en dezelfde weg terug — deze bochten wíl je twee keer rijden.
  📍 [Dades-haarspelden](https://www.google.com/maps/search/?api=1&query=31.5560,-5.9700) · 📷 [Foto's](https://www.google.com/search?tbm=isch&q=Dades+Gorge+hairpins+R704)
- **🎬 Ouarzazate** · "Hollywood van Marokko" (Atlas Studios); tank hier vol en lunch.
...
- **🏔️ Tizi n'Tichka-pas (N9) — 2.260 m** · Klassieke Hoge Atlas-rit: eindeloze bochten over de hoogste asfaltpas van de reis. Recent verbreed en verbeterd — heerlijk sturen. Kleed warm aan; het is fris bovenop.
  📍 [Tizi n'Tichka](https://www.google.com/maps/search/?api=1&query=31.2960,-7.3810) · 📷 [Foto's](https://www.google.com/search?tbm=isch&q=Tizi+n+Tichka+pass)
- **🫖 Optioneel — Telouet** · Verborgen kasbah van de Glaoui-pasja, korte zijweg vanaf de pas.
...
- **☕ Koffiestop — Missour** · Een laatste Marokkaanse koffie; blik terug op de reis.
  📍 [Missour](https://www.google.com/maps/search/?api=1&query=33.0470,-3.9890)
- **🍽️ Lunch + ⛽ tanken — Guercif** · Laatste traditionele lunch (kiptajine, vers brood, muntthee). **Tank hier vol** — één zorg minder vóór de haven.
  📍 [Guercif](https://www.google.com/maps/search/?api=1&query=34.2270,-3.3530)
- **🛳️ Ferry Nador → Almería** · Wees **minimaal 3 uur** vóór vertrek bij de terminal Beni Ansar. Documenten klaar (zie checklist). Zet de motor op de zijstandaard, in de eerste versnelling, neem tankrugzak/waardevolle spullen mee en **fotografeer de parkeerplek** op het autodek.
  📍 [Haven Nador (Beni Ansar)](https://www.google.com/maps/search/?api=1&query=35.2680,-2.9330)
- **🌙 Avondoversteek** · Douche, diner, foto's doorkijken. Aangekomen in Almería slapen of doorrijden.
...
## 💶 Indicatieve kosten per motor/rijder
...
- ✅ **Ferry-boekingsbevestiging** (heen + terug)
- ✅ **Kentekenbewijs** van de motor (op eigen naam of gemachtigde brief)
- ✅ **Rijbewijs** (internationaal rijbewijs aanbevolen)
- ✅ **Verzekeringsbewijs / groene kaart** met Marokko-dekking (controleer of Marokko op de groene kaart staat; anders ter plekke bijverzekeren aan de grens)
- ✅ **Tijdelijke voertuiginvoer (D16 / Déclaration)** — invullen bij binnenkomst; goed bewaren, je levert 'm in bij vertrek
- ✅ Kopieën van alles (papier + foto op telefoon)

> ⚠️ **Belangrijk:** je krijgt bij invoer een tijdelijk invoerdocument per voertuig. **Raak dit niet kwijt** — zonder inlevering bij vertrek krijg je problemen. Verleng je verblijf niet ongemerkt boven de toegestane termijn.

---

## 🧳 Paklijst motorreis Marokko (oktober)

**Kleding & bescherming**
- Motorjas + broek met uitneembare thermovoering (ochtenden Atlas zijn koud, woestijn heet)
- Regenpak (weinig kans, maar Atlas kan omslaan)
- Handschoenen: zomer + tussenseizoen
- Buff/nekwarmer tegen stof, zonnebril
- Lichte kleding voor 's avonds

**Motor & techniek**
- Bandenreparatieset + minipomp/CO₂ per motor
- Basisgereedschap, kabelbinders, tape, ductape
- Reserve: remblokjes, zekeringen, kettingspray (T700), gloeilamp/led
- Laadkabels, powerbank, telefoonhouder, evt. reserve-GPS-kabel
- Sjorbanden (2 lichte spanbanden voor het ferry-autodek)

**Persoonlijk**
- Reisapotheek, zonnebrand (hoge factor), maagtabletten, ORS
- Contant (euro's om te wisselen) + pinpas; niet overal pin
- Lokale simkaart of eSIM
- Kopie documenten, wat kleingeld voor thee/parkeerwachters

---

## 🇲🇦 Klein Marokko-handboek voor onderweg

- **Checkpoints:** politie/gendarmerie-controles zijn normaal. Rustig stoppen, groeten, papieren tonen, glimlachen. Meestal doorwuiven.
- **Snelheid:** binnen de bebouwde kom vaak 40–60 km/u; radarcontroles komen voor. Houd je aan de borden.
- **Tanken:** in het noorden/steden ruim voldoende; vóór woestijn- en bergetappes (dag 4, 5, 10) **altijd voltanken**.
- **Water & eten:** drink flessenwater; tajine, couscous, brochettes en verse muntthee zijn overal veilig en lekker.
- **Geld:** dirham (MAD) is niet vrij verhandelbaar buiten Marokko — wissel/pin ter plekke, hou wat contant voor kleine dorpen.
- **Taal:** Arabisch + Berbers; Frans is de tweede taal. Een paar woorden Frans/Arabisch opent deuren.
- **Fooien & gidsen:** kleine fooi voor parkeerwachters (*gardien*) is gebruikelijk (5–10 MAD).
- **Noodnummers:** politie **19**, gendarmerie (buiten stad) **177**, ambulance **15**.

---

## 📲 Het GPX-bestand in je Garmin Zümo XT laden

**Bestand:** `Marokko_Motorreis_2026.gpx`

1. Sluit de Zümo XT met USB aan op je computer (of gebruik de **Garmin Tread / Drive**-app).
2. Kopieer het `.gpx`-bestand naar de map **`Garmin/GPX`** op het toestel.
3. Op de Zümo: **Apps → Trip Planner / Routes** → importeer.
4. ⚙️ Zet in **Instellingen → Navigatie → Vermijdingen** een vinkje bij **Snelwegen** en **Tolwegen** als je zoveel mogelijk landschappelijke wegen wilt (in Marokko zijn er weinig snelwegen op deze route; laat autoroute wél aan buiten steden).
5. Het bestand bevat **per dag een aparte route** plus alle **waypoints** (bezienswaardigheden, hotels, tank-/koffiestops, kloven en de duinen).

> 💡 **Tip:** verfijn vooraf in **Garmin BaseCamp / Tread**. Werkt ook in **Komoot, OsmAnd, Apple Kaarten en Google My Maps**. In afgelegen gebieden: laad **offline kaarten** (OsmAnd/Google) als back-up.
...
- **Woestijn = geen dieptezand met beladen toermotoren.** Blijf op vaste ondergrond; laat de duinen voor gidsen/quads.
- **Ferry terug:** ruim op tijd, documenten paraat, parkeerplek fotograferen.

---

*Van de cederbossen van de Midden-Atlas tot de stilte van de duinen bij Merzouga en de haarspelden van de Dades — tien dagen die je niet snel vergeet. Goede reis en veel rijplezier. 🏍️☀️🏜️*
